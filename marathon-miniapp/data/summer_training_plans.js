...
const templates = [
  createPlan({
    ...
    testNote: "30K 自测：前 20K 强度有氧，后 10K 保持住约 4:05/km。",
  }),
  createPlan({
    event: "全马",
    code: "300",
    ...
    testNote: "30K 自测：前 20K 强度有氧，后 10K 保持住约 4:12/km。",
  }),
  createPlan({
    event: "全马",
    code: "315",
    ...
    testNote: "30K 自测：前 20K 强度有氧，后 10K 保持住约 4:37/km。",
  }),
  createPlan({
    event: "全马",
    code: "330",
    ...
    testNote: "30K 自测：前 20K 强度有氧，后 10K 保持住约 4:58/km。",
  }),
  createPlan({
    event: "全马",
    code: "345",
